...
urlpatterns = [
    ...
    path("puppet_command/<int:pk>", views.puppet_command, name="puppet_command"),
    path("puppet_api_safe/<int:pk>", views.puppet_api_safe, name="puppet_api_safe"),
    path("puppet_command_safe/<int:pk>", views.puppet_command_safe, name="puppet_command_safe"),
    path("dj_panel/<int:pk>", views.MoxieDJPanelView.as_view(), name="dj_panel"),
    path("dj_api/<int:pk>", views.dj_panel_api, name="dj_api"),
    path("dj_command/<int:pk>", views.dj_command, name="dj_command"),
    path("dj_api_safe/<int:pk>", views.dj_api_safe, name="dj_api_safe"),
    path("dj_command_safe/<int:pk>", views.dj_command_safe, name="dj_command_safe"),
